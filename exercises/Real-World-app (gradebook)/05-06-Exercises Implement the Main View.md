...
2. **Implement** the following three files (notice the JSP fragment suffix `.jspf` in `entry_search_columns.jspf`) in the new subfolder: **entry_search_columns.jspf**
...
1. **Create** a class 
   ...
   `com.liferay.training.gradebook.web.constants.MVCCommandNames`.
