...
@Component(
        property = {
                ...
                "mvc.command.name="+LifeCycleTestPortletKeys.MVC_RENDER_COMMAND_FIRST
        },
...
public class FirstRenderCommand implements MVCRenderCommand{
    ...
    public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
        ...
        System.out.println("***** RenderCommand first *****");
        return LifeCycleTestPortletKeys.PATH_JSP_FIRST;
    }
}
